...
private:
	...
	std::size_t free_space_;

	std::size_t string_length_;

	std::size_t memory_length_;
	...
	static std::size_t calculateMinimumAllocationSize(std::size_t free_space, std::size_t required_size, std::size_t string_length);
