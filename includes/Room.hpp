...
For example, note that "class Room" is missing below -- you have to complete the Room class declaration.
...
public:
	...
	// const version of get_Meeting - if this Room is const, return a reference to const Meeting
